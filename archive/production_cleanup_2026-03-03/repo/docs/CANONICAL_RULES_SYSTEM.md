...
### Location
**[`AGENT_RULES_MASTER.md`](../../root_misc/AGENT_RULES_MASTER.md)** (project root)
...
|------|---------|----------|
| [`AGENT_RULES_MASTER.md`](../../root_misc/AGENT_RULES_MASTER.md) | **Canonical source** | All developers & AI agents |
| [`.github/copilot-instructions.md`](../../../../.github/copilot-instructions.md) | Quick reference | GitHub Copilot |
| [`.claude/instructions.md`](../../../../.github/copilot-instructions.md) | Quick reference | Claude/Zed AI |
| [`.claude/type_checking_guidelines.md`](../../../../.github/copilot-instructions.md) | Type checking specifics | BasedPyRight users |
...
See [`AGENT_RULES_MASTER.md`](../../root_misc/AGENT_RULES_MASTER.md) for contribution guidelines.
...
**Remember:** When in doubt, check [`AGENT_RULES_MASTER.md`](../../root_misc/AGENT_RULES_MASTER.md) - it's the ultimate authority!