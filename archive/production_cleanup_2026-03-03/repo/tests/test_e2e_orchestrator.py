...
from archive.testing_frameworks.legacy.test_e2e_symbols_timeframes import (
    ActionOnError,
    E2ETestConfig,
    E2ETestOrchestrator,
    StageResult,
...
def test_config_creation():
    ...
    config = E2ETestConfig(symbols=["BTCUSD"], timeframes=["H1"], quick_mode=False)
...
def test_config_quick_mode():
    ...
    config = E2ETestConfig(symbols=["BTCUSD"], timeframes=["H1"], quick_mode=True)
