...
class CITestRunner:
    ...
    def test_menu_system(self) -> bool:
        ...
        if success:
            ...
            self.log("  Menu system tests failed", "FAIL")
    ...
    def test_menu_workflow(self) -> bool:
        ...
        if success:
            ...
            self.log("  Menu workflow tests failed", "FAIL")
            self.log(f"  Output: {output[:200]}", "INFO")
    ...
    def test_stress_light(self) -> bool:
        ...
        if success:
            ...
            self.log("  Stress tests failed", "FAIL")
    ...
    def test_performance_profiling(self) -> bool:
        ...
        if success:
            ...
            self.log("  Performance profiling failed", "FAIL")
    ...
    def test_integration(self) -> bool:
        ...
        if success:
            ...
            self.log("  Integration tests failed", "FAIL")
