...
def load_mt5_vantage_data(symbol: str, timeframe: str, bars: int = 5000) -> pd.DataFrame:
    ...
    print("  Source: REAL MT5 VANTAGE TERMINAL DATA")
...
async def run_complete_backtest_async():
    ...
    if not API_TOKEN:
        ...
        return
    ACCOUNT_ID = "e8f8c21a-32b5-40b0-9bf7-672e8ffab91f"  # VantageInternational-Demo (Login: 10916362)
    ...
    print("  3. Run with different symbols")
    print("  4. Enable MT5-style logging (test_mt5_logger.py)")
    print("  5. Enable Grafana export (test_grafana_export.py)")
