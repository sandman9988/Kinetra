...
""")
    ...
    print("")
    print("  Rules to punish MAE/MFE inefficiency:")
    print("  1. Exit if MAE > 0.5% before any MFE (path went wrong)")
    print("  2. Use trailing stop of 0.2-0.3% to lock in MFE")
    print("  3. Take profit at bar +3 if edge ratio dropping")
    print("  4. Never hold past bar +5 without trailing stop lock")
