...
from kinetra.metrics_server import InstrumentMetrics, start_metrics_server
from kinetra.mt5_connector import load_csv_data
from kinetra.rl_gpu_trainer import (
    DQN,
    PhysicsFeatureComputer,
    ReplayBuffer,
    TradingEnv,
    TrainingConfig,
)
...
def detect_device() -> torch.device:
    ...
    if torch.cuda.is_available():
        ...
        if is_rocm:
            ...
            logger.info("  hipBLAS backend configured (TORCH_BLAS_PREFER_HIPBLASLT=0)")
        else:
