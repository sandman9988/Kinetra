...
def main():
    ...
    print("   • Quick test: 20 episodes (~3 min)")
    print("   • Standard: 50 episodes (~7 min)")
    print("   • Thorough: 100 episodes (~15 min)")
    ...
    print("   1. Aggressive (ε: 1.0 → 0.05, decay 0.93)")
    print("   2. Balanced (ε: 1.0 → 0.10, decay 0.95) [default]")
    print("   3. Conservative (ε: 1.0 → 0.20, decay 0.97)")
    ...
    print("\n✅ Key Findings:")
    print("  • Universal agent trained on ALL data")
    print("  • Performance measured across all dimensions")
    print("  • Baseline established for comparison")

    print("\n🔬 Next Steps:")
    print("  1. Analyze which asset classes perform differently")
    print("  2. Explore measurement impact per class")
    print("  3. Test if specialization improves performance")
