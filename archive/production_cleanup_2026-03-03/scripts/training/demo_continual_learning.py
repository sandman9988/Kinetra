...
def simulate_live_trading_session():
    ...
    print("  - TradeLogger: Recording all state/actions")
    print("  - TradeLabeler: Will label trades after closing")
    print("  - ExperienceAnalyzer: Tracking patterns")
    print("  - PrioritizedReplayBuffer: Storing episodes")
    ...
    print("  These are prioritized samples (more poor trades for learning)")

    # Show distribution in batch
    if len(training_batch) > 0:
        # Count experiences by episode label (approximate)
        print("\n  Batch composition:")
        print("    - Experiences ready for RL algorithm (DQN, PPO, etc.)")
        print("    - Higher priority given to poor trades")
        print("    - Agent learns from mistakes faster!")
...
def demonstrate_drift_detection():
    ...
    print("  Completed 20 more trades")
