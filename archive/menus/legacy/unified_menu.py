...
def data_menu():
    ...
    print("""
Options:
  1. Discover Available Data (Scan Filesystem)
  2. Download Data (Interactive)
  3. Download Data (CLI - Specific Instrument)
  4. Consolidate Data (Create Master Standardized)
  5. Audit Data Coverage (Discovery Mode - Recommended)
  6. Audit Data Coverage (Hardcoded Defaults)
  7. Check Data Integrity
  8. Backup Data
  0. Back
    """)

    choice = get_choice("Select", ["0", "1", "2", "3", "4", "5", "6", "7", "8"])
    ...
    if choice == "1":
        ...
        run_script("scripts/audit_data_coverage.py", ["--discover", "--show-gaps"])
    elif choice == "6":
...
def workflow_quick_validation():
    ...
    print("\n📊 Step 1/2: Check data coverage (discovery mode)...")
    run_script("scripts/audit_data_coverage.py", ["--discover", "--show-gaps"])
...
def workflow_full_research():
    ...
    print("\n📊 Step 1/4: Audit current coverage (discovery mode)...")
    run_script("scripts/audit_data_coverage.py", ["--discover", "--show-gaps"])
